...
% openNSx
% 
% Opens and splits an NSx file in smaller pieces.
%
...
%   loaded file will be split in 4 samller files.
%
%   Kian Torab
...
elseif strcmpi(NSx.MetaTags.FileTypeID, 'NEURALCD')
    ...
    disp('This version of openNSx can only read File Specs 2.2 and 2.3');
