...
%
% Added this block to see if SetTrial really is taking all the time
...
return;
% Still accounts for most of reported time in profiler, although not much of elapsed time.
