...
allblocks = 2:17;
zeroblocks = 2:10;
[Data, ablocklist] = readpsychsum([prefix 'bgcdtxpa'],'skip',4);
xo = max([Data.expno]);
[bdata, bblocklist] = readpsychsum([prefix 'bgcdtxp0']);
...
xo = max([Data.expno]);
[bdata, cblocklist] = readpsychsum([prefix 'bgcdtxp2'],'skip',3);
twoblocks = cblocklist.blocks(4:end);
