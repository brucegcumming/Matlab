...
%
%	returns 8 by itterations array of responses of 8 rf's to random contrast stimuli
%	[left_eye_cos, left_eye_sin, right_eye_cos, right_eye_sin,
%	left_eye_cos2, left_eye_sin2, right_eye_cos2, right_eye_sin2]
%	... where the rf's are odd and even gabors shifted the appropriate disparity of two SF's
%
%

% set appropriate rf's
	[rf_left_cos, rf_left_sin, rf_right_cos, rf_right_sin, rf_left_cos2,rf_left_sin2, rf_right_cos2,rf_right_sin2] = Setup_gabor_2rfs(rf_disparity, filtersize, sd, freq);
