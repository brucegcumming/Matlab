function subunits = Setup_gabor_rfs(rf_disparity, filtersize, sd, cycles)
%
...
% make and scale gabor filters (equal area with change of sd)
	...
	rf_left_cos2 = Gabor(centre, sd, cycles, pi);
	rf_left_sin2 = Gabor(centre, sd, cycles, pi/2);
...
% now make right eye with appropriate disparity
	...
	rf_right_cos2 = Gabor(centre + rf_disparity, sd, cycles, pi);
	rf_right_sin2 = Gabor(centre + rf_disparity, sd, cycles, pi/2);
	...
	subunits = [rf_left_cos; rf_left_sin; rf_right_cos; rf_right_sin];
