function [rf_left_cos, rf_left_sin, rf_right_cos, rf_right_sin] = Setup_odd_gabor_rfs(rf_disparity, filtersize, sd, cycles)
%
...
% now make right eye with appropriate disparity
	...
	rf_right_sin = Gabor(centre + rf_disparity, sd, cycles, 1.5 ...
			     * pi);
