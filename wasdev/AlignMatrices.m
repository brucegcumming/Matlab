function [shift, xcs] = AlignMatrices(A,B, dim, varargin) %Finds Best alignment for Matrix of mean Spikes
%[shift, xcs] = AlignMatrices(A,B, dim, varargin)
% A and B are nprobes x nsamples matrices of mean waveforms.
% shift returns the displacement of A relative to B that maximize the
