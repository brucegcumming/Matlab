...
bsymfilter =  [0.2 0 sf 0    -45 sdh sdv 0.5 0];%defines params for this Gabor
csymfilter =  [-0.2 0 sf 0    -45 sdh sdv 0.5 0];%defines params for this Gabor
