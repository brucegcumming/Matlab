...
csymfilter =  [0 0 0.01 -1.57    45 sdh sdv 0.5 0.0];
dsymfilter =  [0 0 0.01 0    0 0.4 0.1 0.5 0.0];%defines params for this Gabor
...
colormap('hot');
subplot (1,3,1);	
output = imagesc (dfiltershape, min(min(dfiltershape)),max(max(dfiltershape)));
colormap('hot');
set(gca,'Ytick',[]);
set(gca,'Xtick',[]);
